...
const view = () => {
  ...
  PageDescription(() => {
    h("p", {
      text:
        "У меня часто спрашивают о том, играл ли я в такую-то игру и что о ней думаю. Поэтому я решил сделать эту страницу с тирлистом игр и кратким обзором каждой",
    });
    h("p", {
