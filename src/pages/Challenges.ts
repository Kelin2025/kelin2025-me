...
const view = () => {
  ...
  PageDescription(() => {
    h("p", {
      text: "Я периодически провожу разные челленджи, приурочивая их к каким-либо значимым событиям канала (либо просто так)"
    });
    h("p", {
      text: "Здесь вы можете увидеть историю всех проведенных челленджей, а также просмотреть их записи"
    });
  });
  Challenges();
};
