...
const view = () => {
  ...
  PageDescription(() => {
    ...
    h("p", {
      text:
        "На кону 3 Steam-версии игры Ori and the Will of the Wisps. Учтите, что я НЕ смогу подарить вам игру, если вашей страны НЕТ в этом списке:"
    });
    h("p", {
      text:
        "Армения, Азербайджан, Беларусь, Грузия, Киргизстан, Казахстан, Республика Молдова, Таджикистан, Туркменистан, Узбекистан, Украина или Россия"
    });
    h("p", {
      text:
